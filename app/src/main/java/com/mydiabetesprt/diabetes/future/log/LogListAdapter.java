...
import com.mydiabetesprt.diabetes.future.log.empty.LogEmptyListItem;
import com.mydiabetesprt.diabetes.future.log.empty.LogEmptyViewHolder;
...
import com.mydiabetesprt.diabetes.future.log.mois.LogMonthListItem;
import com.mydiabetesprt.diabetes.future.log.mois.LogMonthViewHolder;
import com.mydiabetesprt.diabetes.future.log.pending.LogPendingListItem;
import com.mydiabetesprt.diabetes.future.log.pending.LogPendingViewHolder;
import com.mydiabetesprt.diabetes.partage.view.recyclerview.adapter.EndAdapter;
import com.mydiabetesprt.diabetes.partage.view.recyclerview.adapter.StickHeaderAdapter;
import com.mydiabetesprt.diabetes.partage.view.recyclerview.viewholder.BaseViewHolder;

import org.joda.time.DateTime;

class LogListAdapter
    extends EndAdapter<LogListItem, BaseViewHolder<LogListItem>>
    implements EndAdapter.OnEndlessListener, StickHeaderAdapter<LogDayViewHolder> {
     ...
     * @return Position of the first ListItemEntry with the same jour
     */
    ...
    interface Listener extends EntrerSearchListAdapter.OnSearchItemClickListener {
        void onOrderChanges();
        void onSetupEnd();
    }
}