package com.mydiabetesprt.diabetes.partage.view.chart;
...
public class ChartUs {
    ...
    public static void setChartDefaultStyle(BarLineChartBase chart, final type category) {
        ...
        chart.getAxisLeft().setValueFormatter((value, axis) -> FloatUs.parseFloat(value));
    }
