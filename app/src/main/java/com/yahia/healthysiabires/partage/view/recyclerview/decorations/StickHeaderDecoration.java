...
package com.yahia.healthysiabires.partage.view.recyclerview.decorations;
...
public class StickHeaderDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public StickHeaderDecoration(StickHeaderAdapter adapter) {
        this(adapter, false);
    }
     ...
     *         the sticky header adapter to use
     */
    public StickHeaderDecoration(StickHeaderAdapter adapter, boolean renderInline) {
        mAdapter = adapter;
