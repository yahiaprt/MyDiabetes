package com.yahia.healthysiabires.partage.view;
...
import com.yahia.healthysiabires.R;import com.yahia.healthysiabires.partage.data.premier.Victor2D;
...
public class ViewUs {
    ...
    private static final String TAG = ViewUs.class.getSimpleName();
    ...
    public static Victor2D getPositionOnScreen(View view) {
        int[] screenLocation = new int[2];
        view.getLocationOnScreen(screenLocation);
        return new Victor2D(screenLocation[0], screenLocation[1]);
    }
