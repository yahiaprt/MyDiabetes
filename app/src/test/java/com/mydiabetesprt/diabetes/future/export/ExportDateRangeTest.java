...
import com.mydiabetesprt.diabetes.R;import com.mydiabetesprt.diabetes.future.datetemps.choisirletimeUS;
...
public class ExportDateRangeTest {
    ...
    public void pickingDateRangeForCurrentQuarter_shouldApplyToForm() {
        DateTime expectedStart = choisirletimeUS.withStartOfQuarter(DateTime.now());
        DateTime expectedEnd = DateTime.now();
